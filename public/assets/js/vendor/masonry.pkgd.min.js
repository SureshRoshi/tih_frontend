!(function (t) {
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e) {
      var n,
        ...
        v = t.global,
        g = t.stat;
      if ((n = v ? i : g ? i[d] || a(d, {}) : (i[d] || {}).prototype))
        for (f in e) {
          if (
            ((h = e[f]),
            (l = t.noTargetGet ? (p = r(n, f)) && p.value : n[f]),
            !c(v ? f : d + (g ? "." : "#") + f, t.forced) && void 0 !== l)
          ) {
            if (typeof h == typeof l) continue;
            u(h, l);
          }
          (t.sham || (l && l.sham)) && o(h, "sham", !0), s(n, f, h, t);
        }
    };
  },
  function (t, e) {
        ...
        return function (p, d, v, g) {
          for (
            var y,
              ...
              O = 0,
              E = g || a,
              w = e ? E(p, _) : n ? E(p, 0) : void 0;
            _ > O;
            O++
          )
            if ((h || O in b) && ((m = S((y = b[O]), O, x)), t))
              if (e) w[O] = m;
              else if (m)
                switch (t) {
                  case 3:
      ...
      if (
        (j &&
          ...
          d !== Object.prototype &&
            ...
            (l ||
              o(b) === d ||
              (s ? s(b, d) : "function" != typeof b[g] && u(b, g, y)),
            a(b, E, !0, !0),
            l && (h[E] = y))),
        "values" == p &&
          I &&
        ...
        if (
          ...
          for (_ in S) (!v && !w && _ in T) || c(T, _, S[_]);
        else i({ target: e, proto: !0, forced: v || w }, S);
      return S;
    };
  },
  function (t, e, n) {
    ...
    var i = n(3),
      ...
      nt =
        ...
        u(function () {
          ...
          ? function (t, e, n) {
              var i = $(D, e);
              i && delete D[e], Q(t, e, n), i && t !== D && Q(D, e, i);
            }
          : Q,
      it = function (t, e) {
        var n = (U[t] = y(H.prototype));
        return (
      ...
      at = function (t) {
        ...
        return (
          !(this === D && c(U, e) && !c(J, e)) &&
          (!(n || !c(this, e) || !c(U, e) || (c(this, F) && this[F][e])) || n)
        );
      },
      ut = function (t, e) {
        var n = d(t),
        ...
        if (n !== D || !c(U, i) || c(J, i)) {
          var r = $(n, i);
          return (
            !r || !c(U, i) || (c(n, F) && n[F][i]) || (r.enumerable = !0), r
          );
        }
      },
      ct = function (t) {
    ...
    a ||
      (T(
        (H = function () {
          ...
          return s && et && nt(D, e, { configurable: !0, set: n }), it(e, t);
        }).prototype,
        "toString",
        function () {
          return B(this).tag;
      ...
      s &&
        ...
        o || T(D, "propertyIsEnumerable", at, { unsafe: !0 })),
      (C.f = function (t) {
        return it(P(t), t);
      })),
      i({ global: !0, wrap: !0, forced: !a, sham: !a }, { Symbol: H }),
      R(m(K), function (t) {
        A(t);
      }),
      i(
      ...
      H.prototype[k] || w(H.prototype, k, H.prototype.valueOf),
      W(H, "Symbol"),
      (j[F] = !0);
  },
  function (t, e, n) {
      ...
      { target: "Array", proto: !0, forced: !f("slice") },
      {
        slice: function (t, e) {
          ...
          if (
            ...
            return h.call(d, g, y);
          for (
            i = new (void 0 === n ? Array : n)(p(y - g, 0)), f = 0;
            g < y;
            g++, f++
          )
            g in d && c(i, f, d[g]);
        ...
        splice: function (t, e) {
          ...
          if (
            (0 === x
              ...
              : 1 === x
              ? ((n = 0), (i = y - m))
              : ((n = x - 2), (i = h(l(o(e), 0), y - m))),
            y + n - i > 9007199254740991)
          )
            throw TypeError("Maximum allowed length exceeded");
          for (f = u(g, i), p = 0; p < i; p++)
            (d = m + p) in g && c(f, p, g[d]);
          if (((f.length = i), n < i)) {
            for (p = m; p < y - i; p++)
              (v = p + n), (d = p + i) in g ? (g[v] = g[d]) : delete g[v];
            for (p = y; p > y - i + n; p--) delete g[p - 1];
          } else if (n > i)
            for (p = y - i; p > m; p--)
              (v = p + n - 1),
                (d = p + i - 1) in g ? (g[v] = g[d]) : delete g[v];
          for (p = 0; p < n; p++) g[p + m] = arguments[p + 2];
          return (g.length = y - i + n), f;
        },
      }
    );
  },
      ...
      return [
        ...
        function (t, o) {
          ...
          for (var m = []; ; ) {
            ...
            if (null === x) break;
            if ((m.push(x), !g)) break;
            "" === String(x[0]) && (p.lastIndex = c(d, s(p.lastIndex), y));
          }
          for (var b, S = "", _ = 0, O = 0; O < m.length; O++) {
            x = m[O];
            for (
              var E = String(x[0]),
                w = l(h(a(x.index), d.length), 0),
                T = [],
                I = 1;
              I < x.length;
              I++
            )
              T.push(void 0 === (b = x[I]) ? b : String(b));
            var z = x.groups;
            if (v) {
              var j = [E].concat(T, w, d);
              void 0 !== z && j.push(z);
              var L = String(o.apply(void 0, j));
            } else L = i(E, d, w, T, z, o);
            w >= _ && ((S += d.slice(_, w) + L), (_ = w + E.length));
          }
          return S + d.slice(_);
        },
      ];
        ...
        concat: function (t) {
          ...
          for (e = -1, i = arguments.length; e < i; e++)
            if (((o = -1 === e ? s : arguments[e]), v(o))) {
              if (h + (r = u(o.length)) > 9007199254740991)
                throw TypeError("Maximum allowed index exceeded");
              for (n = 0; n < r; n++, h++) n in o && c(l, h, o[n]);
            } else {
      ...
      return [
        ...
        function (t) {
          ...
          for (var l, h = [], p = 0; null !== (l = u(s, c)); ) {
            var d = String(l[0]);
            (h[p] = d),
              "" === d && (s.lastIndex = a(c, o(s.lastIndex), f)),
              p++;
          }
          return 0 === p ? null : h;
        },
    ...
    n.r(e),
      function (t) {
         ...
         */ !(function (i, r) {
          ...
          (function (i, r) {
            "function" == typeof define && n(55)
              ? define("ev-emitter/ev-emitter", r)
              : "object" == e(t) && t.exports
              ? (t.exports = r())
              : (i.EvEmitter = r());
          ...
          (function (i, r) {
            ...
            function r(r) {
              if (
                ...
                for (
                  var f = (c.isBorderBox = "border-box" == s.boxSizing), l = 0;
                  u > l;
                  l++
                ) {
                  var h = a[l],
                ...
                var v = c.paddingLeft + c.paddingRight,
                  ...
                  S = f && o,
                  _ = t(s.width);
                !1 !== _ && (c.width = _ + (S ? 0 : v + x));
                var O = t(s.height);
                return (
                  !1 !== O && (c.height = O + (S ? 0 : g + b)),
          ...
          (function (i, r) {
            "function" == typeof define && n(55)
              ? define("desandro-matches-selector/matches-selector", r)
              : "object" == e(t) && t.exports
              ? (t.exports = r())
              : (i.matchesSelector = r());
          })(window, function () {
          ...
          (function (i, r) {
            "function" == typeof define && n(55)
              ...
              : "object" == e(t) && t.exports
              ? (t.exports = r(i, n(223)))
              : (i.fizzyUIUtils = r(i, i.matchesSelector));
          })(window, function (t, n) {
            var i = {
                extend: function (t, e) {
                ...
                return (
                  t.forEach(function (t) {
                    if (t instanceof HTMLElement) {
                      if (!e) return void r.push(t);
                      n(t, e) && r.push(t);
                      for (
                        var i = t.querySelectorAll(e), o = 0;
                        o < i.length;
                        o++
                      )
                        r.push(i[o]);
              ...
              (i.htmlInit = function (e, n) {
                i.docReady(function () {
                  var r = i.toDashed(n),
                    ...
                    c = i.makeArray(a).concat(i.makeArray(u)),
                    f = s + "-options",
                    l = t.jQuery;
                  c.forEach(function (t) {
                    var i,
                      r = t.getAttribute(s) || t.getAttribute(f);
                    try {
                      i = r && JSON.parse(r);
                    } catch (e) {
                      return void (
          ...
          (function (i, r) {
            "function" == typeof define && n(55)
              ...
              : "object" == e(t) && t.exports
              ? (t.exports = r(i, n(131), n(143), n(224), n(225)))
              : (i.Outlayer = r(
                  i,
                  i.EvEmitter,
                  i.getSize,
  ...
  function (t, e) {
    t.exports = desandro - matches - selector;
  },
  function (t, e) {
    t.exports = fizzy - ui - utils;
  },
  function (t, e) {
    t.exports = item;
  },
