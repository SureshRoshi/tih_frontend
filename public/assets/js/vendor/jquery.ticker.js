  ...
  $.fn.ticker = function (options) {
    ...
    return this.each(function () {
      ...
      function initialisePage() {
        ...
        $(newsID).wrap(
          '<div id="' + settings.dom.wrapperID.replace("#", "") + '"></div>'
        );
      ...
      function setupContentAndTriggerDisplay() {
        ...
        $(settings.dom.titleElem).html(
          settings.newsArr["item-" + settings.position].type
        );
        $(settings.dom.contentID).html(
          settings.newsArr["item-" + settings.position].content
        );
